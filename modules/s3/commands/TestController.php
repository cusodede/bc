 ...
 * Простой контроллер для тестировании Minio
 */
class TestController extends Controller {
	 ...
	 * command yii s3/test/put /my/path/file.txt fileKey [my-bucket]
	 ...
	 * command yii s3/test/get fileKey [my-bucket] [/path/to/save]
	 * @param string $filepath
	 * @param null|string $bucket
	 * @param string $key
	 * @return void
	...
	/**
	 * Инфо о файле
	 * command yii s3/test/head fileKey [my-bucket]
	 * @param null|string $bucket
	 * @param string $key
	 * @return void
	 */
	 ...
	 * command yii s3/test/delete my-bucket fileKey
	 * @param string $bucket
	 * @param string $key
	 * @return void
	 */
	 ...
	 * command yii s3/test/list [my-bucket]
	 * @param null|string $bucket
	 * @return void
	 */
	 ...
	 * command yii s3/test/listBuckets
	 * @return void
	 */
