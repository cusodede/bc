...
/**
 * @var View $this
 * @var SubscriptionsSearch $searchModel
	...
	'grid' => GridView::begin([
		...
		'columns' => [
			[
				...
				'buttons' => [
					'edit' => static function(string $url, Subscriptions $model): string {
						return Html::ajaxModalLink('<i class="fas fa-edit"></i>', $url, [
							'class' => ['btn btn-sm btn-outline-primary']
						]);
					},
					'view' => static function(string $url, Subscriptions $model): string {
