	...
	<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-auto">
		<div class="card p-4 rounded-plus bg-faded">
			...
			<div class="row mb-lg-4">
				...
				<div class="col-md-6">
					<?= Html::link('<i class="fa fa-sms fa-lg opacity-100 color-primary-500 mr-1"></i>Войти по SMS', SiteController::to('login-sms'), [
			...
			<div class="mt-1 ">
				<?= Html::link('Восстановление пароля', SiteController::to('restore-password'), ['class' => 'btn-link fa-pull-left text-left']) ?>
				<?= Html::link('Регистрация', SiteController::to('register'), ['class' => 'btn-link fa-pull-right text-right']) ?>
			</div>
		</div>
	</div>
</div>