...
/**
 * @var View $this
 * @var ContractsSearch $searchModel
...
<?= GridConfig::widget([
	...
	'grid' => GridView::begin([
		...
		'toolbar' => [
			['content' => Html::ajaxModalLink('Добавить договор', $controller::to('create'), ['class' => ['btn btn-success']])]
		],
		'export' => false,
		...
		'columns' => [
			[
				...
				'buttons' => [
					'edit' => static function(string $url, Contracts $model) {
						return Html::ajaxModalLink('<i class="fas fa-edit"></i>', $url, [
							'class' => ['btn btn-sm btn-outline-primary']
						]);
					},
					'view' => static function(string $url, Contracts $model) {
