...
class m210514_071111_initial_fill_sys_permissions extends Migration {
	...
	public function safeUp() {
		...
		('Выполне планов сотрудника', '', null, null, 'Инфо о выполнении планов на сотрудника', 0),
		...
		('Просмотр РД', '', null, null, 'Просмотр рабочых данных(РД). Должна отображаться информация о перечне оказанных услуг, бонусных начислениях, тарифах начисления бонусов, достижений, целей мотивационной программы, информация об использованных бонусах, статусы потдверждения услуг и причины неподтверждения', 0),
		...
		('Подтверждения/регистрации сотрудникав бэк-офисе', '', null, null, 'Возможность подтверждения/регистрации сотрудника в бэк-офисе СНМП', 0),
